...
本プロジェクトは、「学習を記録するアプリ」ではなく
「学習行動を継続させる体験」を作ることを目的に仮説検証型で改善を重ねています。

- 機能追加はすべて、
・行動の摩擦を減らせているか
・記録と報酬の距離を縮められているか
という観点で検証し、仮説改善を繰り返しています。
...
## [1.1.2] - 2026-02-11
### 追加 (Added)
- 「記録」という行為をユーザーの“作業”にしないため、入力主体設計から行動主体設計へ方針転換。
- **学習時間入力方式をタイマー計測方式に変更**
...
- AI学習アドバイザー「AIロボット」機能の実装
  保存完了を“イベント”として扱い、その瞬間にフィードバックを挿入することで行動と報酬の距離を最小化。
